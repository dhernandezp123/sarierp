-- Fase 5: reemplazo atomico de tablas hijas de cotizacion.
...
begin
  ...
  if p_replace_containers then
    ...
    delete from public.quotation_containers
  ...
  if p_replace_cargo then
    ...
    delete from public.quotation_cargo_lines
    where quotation_id = p_quotation_id;
